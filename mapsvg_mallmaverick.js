 ...
 * https://codecanyon.net/user/Yatek/portfolio?ref=Yatek
 *
 * Version : 5.6.3
 * Released: February 19, 2014
 *
 * You must purchase Regular or Extended license to use mapSvg plugin.
 * Visit plugin's page @ CodeCanyon: https://codecanyon.net/item/jquery-interactive-svg-map-plugin/1694201
 * Licenses: https://codecanyon.net/licenses/regular_extended
 */
...
var mapSVG = function(elem, options){
    ...
    this.methods = {
       ...
       regionAdd : function (_item){
         ...
         *  Taken from https://stackoverflow.com/questions/801406/c-create-a-lighter-darker-color-based-on-a-system-color/801463#801463
         */
        ...
        init : function(opts, elem) {
            ...
            if(opts.source.indexOf('https://') == 0 || opts.source.indexOf('https://') == 0)
...
//                    },
                success:  function(xmlData){
                    ...
                    _data.svgDefault.width = $(this).attr('width');
                    _data.svgDefault.width = _data.svgDefault.width ? _data.svgDefault.width.replace(/px/g,'') : '';
                    console.log('-------');
                    console.log(_data);

                    _data.svgDefault.height = $(this).attr('height');
                    _data.svgDefault.height = _data.svgDefault.height ? _data.svgDefault.height.replace(/px/g,'') : '';
